...
vtkStandardNewMacro(CustomColorTransferFunction);
  ...
  bool forceExactSupportColors = false)
{
    ...
    (val[1] != rgb2[0] || val[2] != rgb2[1] || val[3] != rgb2[2]))
  {
    ...
    {
      cachedPathCTF = vtkSmartPointer<CustomColorTransferFunction>::New();
    }
    else
    {
...
CustomColorTransferFunction::CustomColorTransferFunction()
{
...
int CustomColorTransferFunction::GetSize()
{
...
double* CustomColorTransferFunction::GetDataPointer()
{
...
//------------------------------------------------------------------------------
// Add a point defined in RGB
int CustomColorTransferFunction::AddRGBPoint(
...
int CustomColorTransferFunction::AddRGBPoints(vtkDoubleArray* x, vtkDoubleArray* rgbColors)
{
...
//----------------------------------------------------------------------------
// Bulk add points defined in RGB
int CustomColorTransferFunction::AddRGBPoints(
...
int CustomColorTransferFunction::AddHSVPoint(double x, double h, double s, double v)
{
  double r, b, g;
...
//------------------------------------------------------------------------------
// Add a point defined in HSV
int CustomColorTransferFunction::AddHSVPoint(
...
// the Range
void CustomColorTransferFunction::SortAndUpdateRange()
{
...
//------------------------------------------------------------------------------
bool CustomColorTransferFunction::UpdateRange()
{
  double oldRange[2];
...
//------------------------------------------------------------------------------
// Remove a point
int CustomColorTransferFunction::RemovePoint(double x)
{
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::MovePoint(double oldX, double newX)
{
  if (oldX == newX)
  {
    // Nothing to do.
...
//------------------------------------------------------------------------------
// Remove all points
void CustomColorTransferFunction::RemoveAllPoints()
{
  for (unsigned int i = 0; i < this->Internal->Nodes.size(); i++)
  {
    delete this->Internal->Nodes[i];
...
void CustomColorTransferFunction::AddRGBSegment(
...
void CustomColorTransferFunction::AddHSVSegment(
...
const unsigned char* CustomColorTransferFunction::MapValue(double x)
{
  double rgb[3];
  this->GetColor(x, rgb);
...
void CustomColorTransferFunction::GetColor(double x, double rgb[3])
{
...
double CustomColorTransferFunction::GetRedValue(double x)
{
  double rgb[3];
  this->GetColor(x, rgb);
...
double CustomColorTransferFunction::GetGreenValue(double x)
{
  double rgb[3];
  this->GetColor(x, rgb);
...
double CustomColorTransferFunction::GetBlueValue(double x)
{
  double rgb[3];
  this->GetColor(x, rgb);
...
void CustomColorTransferFunction::GetTable(double xStart, double xEnd, int size, double* table)
{
  ...
  vtkSmartPointer<CustomColorTransferFunction> ciede2000Helper = nullptr;
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::GetTable(double xStart, double xEnd, int size, float* table)
{
...
//------------------------------------------------------------------------------
const unsigned char* CustomColorTransferFunction::GetTable(double xStart, double xEnd, int size)
{
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::BuildFunctionFromTable(
...
int CustomColorTransferFunction::GetNodeValue(int index, double val[6])
{
  int size = static_cast<int>(this->Internal->Nodes.size());
...
//------------------------------------------------------------------------------
// For a specified index value, get the node parameters
int CustomColorTransferFunction::SetNodeValue(int index, double val[6])
{
  int size = static_cast<int>(this->Internal->Nodes.size());
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::DeepCopy(vtkScalarsToColors* o)
{
    CustomColorTransferFunction* f = nullptr;
  if (o)
  {
    this->Superclass::DeepCopy(o);
    f = CustomColorTransferFunction::SafeDownCast(o);
  }
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::ShallowCopy(CustomColorTransferFunction* f)
{
  if (f != nullptr)
  {
...
// and unsigned short.
template <class T>
void vtkColorTransferFunctionMapData(CustomColorTransferFunction* self, T* input,
...
static void vtkColorTransferFunctionMapData(CustomColorTransferFunction* self, unsigned char* input,
...
static void vtkColorTransferFunctionMapData(CustomColorTransferFunction* self, unsigned short* input,
  unsigned char* output, int length, int inIncr, int outFormat, int)
{
  int x;
  int i = length;
...
//------------------------------------------------------------------------------
template <class T>
void vtkColorTransferFunctionIndexedMapData(CustomColorTransferFunction* self, T* input,
  unsigned char* output, int length, int inIncr, int outFormat, long)
{
  int i = length;
  double nodeVal[6];
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::MapScalarsThroughTable2(void* input, unsigned char* output,
...
//------------------------------------------------------------------------------
vtkIdType CustomColorTransferFunction::GetNumberOfAvailableColors()
{
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::GetIndexedColor(vtkIdType idx, double rgba[4])
{
...
//------------------------------------------------------------------------------
void CustomColorTransferFunction::FillFromDataPointer(int nb, double* ptr)
{
  if (nb <= 0 || !ptr)
  {
    return;
...
//------------------------------------------------------------------------------
int CustomColorTransferFunction::AdjustRange(double range[2])
{
  if (!range)
  {
    return 0;
...
//------------------------------------------------------------------------------
int CustomColorTransferFunction::EstimateMinNumberOfSamples(double const& x1, double const& x2)
{
...
//------------------------------------------------------------------------------
double CustomColorTransferFunction::FindMinimumXDistance()
{
...
void CustomColorTransferFunction::PrintSelf(ostream& os, vtkIndent indent)
{
