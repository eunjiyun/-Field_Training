 ...
 *
 *
 * CustomColorTransferFunctionis a color mapping in RGB or HSV space that
...
class CustomColorTransferFunction: public vtkScalarsToColors
{
public:
  static CustomColorTransferFunction* New();
  vtkTypeMacro(CustomColorTransferFunction, vtkScalarsToColors);
  void DeepCopy(vtkScalarsToColors* f) override;
  void ShallowCopy(CustomColorTransferFunction* f);
...
protected:
    CustomColorTransferFunction();
  ~CustomColorTransferFunction() override;
...
private:
    CustomColorTransferFunction(const CustomColorTransferFunction&) = delete;
  void operator=(const CustomColorTransferFunction&) = delete;
};
